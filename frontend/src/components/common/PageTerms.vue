<template>
  <TmPage data-title="Terms" hide-header>
    <div class="card">
      ...
      <p class="c3">
        These Terms of Service (the “Terms” or this “Agreement”) apply to the
        “universal wallet” service Harmony (“Harmony” or the “App”) and other 
        digital services offered on behalf of Simple Rules Company (“SRC”).
        SRC is a corporation organized under the laws of Delaware. The “universal wallet” 
        application and other digital services, software, websites, applications, 
        user interfaces, features, functionalities, content and related updates and 
        upgrades are referred to in these Terms collectively as the “Services”.
      </p>
      <p class="c3">
        These Terms are a legal contract between you and SRC that governs your use of SRC 
        and your rights and obligations relating to the Services.
      </p>
      <p class="c3">
        <span
          >AAs used in these Terms SRC, “we”, “us”, “ours” and similar terms refers to SRC 
          International Software Systems Inc.. The term “Developers” and “Third-Party Developers” 
          in these Terms refer to third-party developers who have (i) developed features for SRC 
          and/or (ii) provide support and/or services in relation to SRC (an example is analytics) 
          or the Services and/or (iii) provide support and/or services to users of SRC and/or Services 
          (examples are customer support and features that allow you to value Digital Assets 
          (as defined below)).</span
        >)).
      </p>
      <p class="c3">
          THESE TERMS CONTAIN IMPORTANT TERMS AND CONDITIONS THAT AFFECT YOU AND YOUR USE OF SRC AND THE SERVICES, 
          INCLUDING A PROVISION REGARDING BINDING ARBITRATION (OTHER THAN CERTAIN SMALL CLAIMS), 
          A LIMITATION OF THE AMOUNT OF TIME YOU HAVE TO BRING CLAIMS AGAINST SRC AND A WAIVER OF 
          CERTAIN RIGHTS TO JURY TRIAL AND/OR CLASS ACTIONS. PLEASE READ THE DISPUTE RESOLUTION SECTION 16 IN ITS ENTIRETY.
      </p>
      <p class="c3">
        PLEASE READ THESE TERMS CAREFULLY BEFORE YOU USE SRC AND/OR SERVICES. 
        BY SETTING UP A SRC ACCOUNT AND/OR USING SRC OR THE SERVICES, YOU AFFIRM THAT:
      </p>
      ...
      <p class="c3">
          ...
          THEN YOU MUST NOT USE SRC OR THE SERVICES.
      </p>
      <ol class="c5 lst-kix_list_7-0 start" start="1">
        ...
        <p class="c3">
          We reserve the right to change or modify these Terms on a going forward basis at any time and in our sole discretion, so please review it frequently. If we make changes to these Terms, we will provide notice of such changes as appropriate, such as by sending an email notification to the address you have provided, providing notice on SRC and/or updating the “last updated” date on the top of these Terms. Your continued use of SRC and the Services will confirm your acceptance of the changes. If you do not agree to the changes, you must stop using SRC and the Services. We encourage you to review these Terms from time to time to ensure you understand the terms and conditions that apply to your access to, and use of, SRC and the Services.Account
        </p>
        <li class="c2">
          Account
        </li>
        <p class="c3">
          You may be required to create an account (“Account”) to use certain features of SRC and/or the Services. When you create an Account, you must comply with the verification and setup process in order to use these Service features. You agree you will maintain your Account information to ensure that it is always current, complete and accurate. If you provide untrue, incomplete, misleading or inaccurate information, you understand that we have the right to terminate your Account and use of the Services. These Terms take effect as soon as you complete registration and indicate acceptance of these Terms. You may not set up an Account or access the Services unless you agree to be bound by these Terms.
        </p>
        <p class="c3">
          SRC and the Services are intended solely for users who are 13 or older. Registration by anyone under the age of 13 is unauthorized and in violation of these Terms. If you are aged between the relevant minimum age and 18 (or the age of majority where you live), you and your parent or guardian must review this Agreement together. Parents and guardians are responsible for the acts of children under 18 years of age when using Services. We recommend that parents and guardians familiarize themselves with parental controls on devices they provide their child.
        </p>
        <p class="c3">
          You represent and warrant that you (a) are not under the age of 13, (b) are not identified on the Office of Foreign Assets Control’s Specially Designated Nationals List (“SDN List”), (c) are not placed on the U.S. Department of Commerce’s Denied Persons List or Entity List or any other U.S. export control list, (d) will not use IP proxying or other methods to disguise the place of your residence, (e) will not use SRC or the Services if any applicable laws in your country prohibit you from doing so in accordance with these Terms, (f) will not use SRC or the Services in any way that is illegal or unlawful, in any way that promotes or otherwise supports illegal or unlawful activities, or violates SRC’s Rules of Conduct and (g) have not previously had your right to use SRC or the Services suspended or terminated.
        </p>
        <p class="c3">
        ...
        <p class="c3">
          If you are using our Services on behalf of a business, then you affirm to us that you are authorized to agree to these Terms on behalf of the business.Services
        </p>
        <li class="c2">
          Services
        </li>
        <p class="c3">
          SRC and the Services provide software tools for users to access and manage various features and functions related to digital assets including tokens, cryptocurrencies, virtual currencies or any other digital assets you own that are supported by SRC and the Services (collectively, “Digital Assets”), including interfacing with third-party sources for certain information regarding the value of Digital Assets. The Services do not purchase, sell, store or exchange Digital Assets. We do not recommend that you use the Services unless you are familiar with Digital Assets, Blockchain technology and can securely store your own private key. SRC includes information about various Digital Assets native to the Harmony System, however, such inclusion or availability of information does not imply endorsement by us of such Digital Assets. SRC is not associated with the operators of any Digital Assets and makes information related to such Digital Assets available for your convenience only. You understand and accept the inherent security risks of using the Internet.
        </p>
        <p class="c3">
          We and/or our third-party partners retain full and complete title to all information and materials provided by us or our partners on or through SRC and the Services, including any artwork, graphics, text, video and audio clips, trademarks, logos and other content (collectively, “SRC Content”), except in each case, as provided in the next sentence. SRC is releasing its source code in fully open source format and all of SRC’s source code is licensed under the Apache 2.0 License. For purposes of clarification, SRC Content is part of the Services. All trademarks are the property of their respective owners.
        </p>
        <p class="c3">
          Except for content that is in the public domain or unless we provide you with written authorization to do so, you may not:
        </p>
        <ul class="lst-kix_list_25-0 start">
          <li class="c3 c6">
            Incorporate any of the Services into any other work (such as your
            own website) or use them in any public or commercial manner;
          </li>
          <li class="c3 c6">
            Copy, modify, reproduce, adapt, reverse engineer, distribute, frame, republish, upload, display, post, transmit or transfer SRC, except as permitted by the Apache 2.0 license with regard to the SRC source code;
          </li>
          <li class="c3 c6">
            <span
              >License or sell SRC or the Services in any form or by any means;</span
            >
          </li>
          <li class="c3 c6">
            Change any of the notices about copyright, trademarks or other intellectual property rights that may be part of SRC or the Services; or
          </li>
          <li class="c3 c6">
            Scrape data or code from SRC or the Services.
          </li>
        </ul>
        <p class="c3">
          Although we make reasonable efforts to update the information on SRC and the Services, we make no representations, warranties or guarantees, whether express or implied, that SRC or the Services are accurate, complete or up to date. Except as required by law,we disclaim any duty to update the information included on SRC or the Services. All information on SRC and the Services is subject to change without notice.
        </p>
        <p class="c3">
          You do not acquire any right or interest in SRC or the Services, except for the limited use right expressly stated in these Terms. If you access and use SRC, then we grant you a limited, non-exclusive, and non-transferable license to download, install, and use SRC for your personal, non-commercial use on a computer and, when applicable, a mobile smartphone and/or tablet device owned or controlled by you (your “Device”) on the terms and conditions set forth in these Terms. This license ends immediately, without further action of either party upon the earliest of (a) termination of this Agreement or (b) our termination of your Account in accordance with the terms of this Agreement.
        </p>
        <li class="c2">
          Using the Services
        </li>
        <p class="c3">
          You are responsible for the software, Device and other hardware, Internet service and mobile data service (and all associated fees) that you need to access and use SRC and/or the Services. We do not currently charge any fees for SRC or the Services but reserve the right to do so in the future. If we impose a fee, you will be given thirty (30) days’ prior notice by means of an amendment to these Terms prior to the fees becoming effective.
        </p>
        <p class="c3">
          Eligibility: To access and use SRC and the Services, you must be a resident of a Permitted Region (see Section 15 for details) and be the age of majority or older in your state or country of residence.
        </p>
        <p class="c3">
        ...
        <p class="c3">
          The list of Digital Assets supported by the Services may be updated or modified from time to time in our sole discretion and is located on the SRC webpage.
        </p>
        <p class="c3">
          Availability of the Services: We do not guarantee availability of SRC and/or the Services at all times of the day. The availability of SRC and the Services may be subject to limitations, delays and other problems inherent in the use of the Internet and electronic communications, blockchain network congestion or network issues, all of which are outside of our control.
        </p>
        <li class="c2">
          Restrictions on Use of SRC and Services
        </li>
        <p class="c3">
        ...
        <ul class="lst-kix_list_23-0 start">
          <li class="c3 c6">
            Breach, test, circumvent (or attempt to breach, test or circumvent)
            any security, copy protection or rights management feature in the
            Services or otherwise attempt to gain unauthorized access to the
            Services, other users&rsquo; Accounts or our computer systems or
            networks;
          </li>
          <li class="c3 c6">
            Copy, modify, translate, adapt or otherwise create derivative works
            or improvements (whether or not patentable) of any part of SRC or
          ...
          <li class="c3 c6">
            ...
            intellectual property or proprietary notices contained in SRC or
            the Services;
          </li>
          <li class="c3 c6">
            ...
            mine or index any portion of SRC or the Services;
          </li>
          <li class="c3 c6">
            ...
            exploit any features or functionality of SRC or the Services
            including through time-sharing, use of service bureau or by
            otherwise making SRC or the Services available on a network on
          ...
          <li class="c3 c6">
            ...
            SRC or the Services without our written consent;
          </li>
          <li class="c3 c6">
            Negligently, recklessly, knowingly, or intentionally transmit or
            upload any material that contains viruses, time bombs, trojan
            horses, worms, malware, spyware, or any other programs that may be
          ...
          <li class="c3 c6">
            ...
            aspect of SRC or the Services or otherwise interfere with
            others&rsquo; use and enjoyment of SRC or the Services;
          </li>
          <li class="c3 c6">
          ...
          <li class="c3 c6">
            Collect or store Personal Information (as defined in the Privacy
            Policy) about or otherwise invade the privacy of any other user
            without his or her express prior written consent; or
          </li>
          <li class="c3 c6">
            Attempt to circumvent or evade any content filtering or blocking
            techniques we employ, or attempt to access SRC or the Services
        ...
        <p class="c3">
          By using the Services and accessing SRC you consent to receiving
          ...
          emails, payment emails, emails relating to SRC, the Services,
          ...
          including that such communications be in writing. You should maintain
          copies of electronic communications. You also consent to receiving
          certain other communications from us, such as content offers, special
          offers and promotions.
        </p>
        <p class="c3">
          Message and data rates may apply to communications. Once you opt-in to
          receive text messages from us, the frequency of text messages that we
          send to you depends on your transactions with us. All charges are
          ...
          Text message services are provided on an &ldquo;as is&rdquo; basis and
          may not be available in all areas at all times.
        </p>
        <p class="c3">
          By agreeing to receive text messages, you understand and agree that we
          may use an automatic dialing system to deliver text messages to you
          and that your consent to receive text messages is not required as a
          condition of purchase for any goods or services.
        </p>
        <p class="c3">
          If you do not want to receive these non-transactional communications,
          you may opt out of the communications by selecting
          &ldquo;unsubscribe&rdquo; on any email or texting back
          &ldquo;STOP&rdquo; on any texts. Please review our Privacy Policy for
          further detail on communications.
        </p>
        <li class="c2">
          Modification to SRC And Services
        </li>
        <p class="c3">
          We may from time to time perform upgrades, updates, bug fixes, or
          error corrections to SRC or the Services (&ldquo;Updates&rdquo;) or
          otherwise make SRC or the Services unavailable.
        </p>

        <p class="c3">
          Based on your Device settings, when your Device is connected to the
          Internet either SRC may automatically download and install all
          ...
          all Updates to ensure that SRC operates properly.
        </p>
        <p class="c3">
          <span
            ...
            stop providing SRC and/or any or all of the Services at any time
            and without notice. Except as expressly agreed in writing, we have
            no obligation to provide access to or support for SRC and the
            Services and we are not responsible for any delay, delivery
            failureor other damage resulting from use</span
          >of SRC or the Services. Updates are part of the Services and
        ...
        <p class="c3">
          <span
            ...
            PROHIBIT ACCESS TO SRC AND OR THE SERVICES AND OR YOUR ACCOUNT AND
        ...
        <p class="c3">
          We do not guarantee that SRC and/or Services can be accessed on all
        ...
        <p class="c3">
          <span
            >Certain software may be required to access and use SRC and/or the
            Services. We may need to automatically update some of the software
            you obtain through SRC and/or the Services or provide you with new
            ...
            By using SRC, you agree to such automatic updating</span
          ><span class="c1">.</span>
        </p>
        <li class="c2">
          Rules of Conduct
        ...
        <p class="c3">
          Your online conduct and interaction with others who use SRC and/or
          ...
          negatively affects the enjoyment of SRC or the Services by other
          users. You acknowledge that we do not have to give you notice before
          terminating your Account.
        </p>
        <p class="c3">
          When you access or use SRC or the Services, you agree that you will
          not:
        </p>
        <ul class="lst-kix_list_2-0 start">
          ...
          <li class="c3 c6">
            Access or use SRC or Services in any manner that could interfere
            with, disrupt, negatively affect, or inhibit anyone from fully
            enjoying SRC or the Services, including but not limited to in any
            ...
            another&rsquo;s privacy, pornographic or otherwise offensive or
            reasonably objectionable.
          </li>
          <li class="c3 c6">
            Publish, post, upload or otherwise make available any content
            (including screen names or personas) or information, or organize or
            participate in any activity, group or guild that is inappropriate,
            abusive, defamatory, harassing, threatening, bigoted, hateful,
            profane, threatening, offensive, vulgar, bullying, obscene, sexually
            explicit, defamatory, infringing, invades another&#39;s privacy,
            pornographic or otherwise offensive or reasonably objectionable.
          </li>
          <li class="c3 c6">
            Use any server or network used to support or provide SRC or a
            Service, including any hacking or cracking into a Service.
          </li>
          <li class="c3 c6">
            Use any software or program that damages, interferes with or
            disrupts SRC or a Service or another&#39;s computer or property,
          ...
          <li class="c3 c6">
            Publish, post, upload or otherwise make available any content or
            information that is illegal or that you don&#39;t have permission to
            freely distribute (including due to intellectual property laws,
            rights of privacy or rights of publicity).
          </li>
          <li class="c3 c6">
            Post a message for any purpose other than personal communication.
            Prohibited messages include advertising, surveys, contests, spam,
            chain letters, pyramid schemes, duplicative emails and other types
            of solicitation or unsolicited emails (commercial or otherwise).
          </li>
          <li class="c3 c6">
            Impersonate another person or falsely imply that you are our
            employee or representative.
          </li>
          <li class="c3 c6">
            Improperly use support or complaint buttons or make false reports to
            our employees, third-party representatives or customer service
            forums.
          </li>
          <li class="c3 c6">
            Attempt to obtain, or phish for, a password, account information, or
            other private information from anyone else on SRC or utilizing the
            Services.
          </li>
          <li class="c3 c6">
          ...
          <li class="c3 c6">
            ...
            this website for any purpose or copy any material on this website.
          </li>
          <li class="c3 c6">
            Use or distribute unauthorized software programs or tools, such as
            &quot;auto&quot; software programs, &quot;macro&quot; software
            programs or applications, exploits, or any other hacking or altering
            software or tool.
          </li>
          <li class="c3 c6">
          ...
          <li class="c3 c6">
            Use a Service or access SRC in a Restricted Region. We may use
          ...
          <li class="c3 c6">
            Use someone else&rsquo;s identity to create an Account or for any
            other purpose (including an in-game persona).
          </li>
          <li class="c3 c6">
            Promote, encourage or take part in any prohibited activity described
            above.
          </li>
        </ul>
        <p class="c3">
          ...
          Services and SRC, or terminating your Account. When practical, we
        ...
        <p class="c3">
          ...
          Services&rdquo;). Linked Services are not under our control and we are
          not responsible for Linked Services or for any information or
          materials on, or any form of transmission received from any Linked
          Service. The inclusion of a link does not imply our endorsement of the
          Linked Services, any cryptocurrencies or Digital Assets, or any
          association with the operators of the Linked Services. We do not
        ...
        <p class="c3">
          ...
          liability to you for the following risks: (a) operating system
          failures of your Device; (b) interactions between your Device and the
          Services; (c) viruses, malware or other malicious software on your
          Device; (d) communication delays between the Services and a node or
          relay service for Digital Assets asset (and vice versa); (e) failure
          to display the currentmarket value and/or price for Digital Assets;
          (f) theft of or inability to access Digital Assets; or (g) system or
          network availability or availability of or access to the Services.
        </p>
        <p class="c3">
          SRC AND THE SERVICES AND POSTING OF USER GENERATED CONTENT AND
          FEEDBACK IS AT YOUR SOLE RISK. SRC AND SERVICES AND ALL OTHER
        ...
        <p id="h.1fob9te" class="c3">
          ...
          LICENSORS (FOR PURPOSES OF THIS PARAGRAPH, THE &ldquo;SRC
          PARTIES&rdquo;) DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, STATUTORY
          OR OTHERWISE, IN CONNECTION WITH SRC, THE SERVICE AND ALL OTHER
          ...
          SRC, THE SERVICES, AND ANY CONTENT, MATERIAL OR INFORMATION IN
          CONNECTION WITH SRC (COLLECTIVELY, THE &ldquo;DISCLAIMED
          ...
          FOREGOING. SRC PROVIDES NO WARRANTY OR UNDERTAKING, AND MAKES NO
        ...
        <p class="c3">
          <span
            >THE SRC PARTIES MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
            ...
            THE DISCLAIMED ITEMS. THE SRC PARTIES ASSUME NO LIABILITY OR
            ...
            TO ACCESS AND USE, THE DISCLAIMED ITEMS; (C) ANY UNAUTHORIZED ACCESS
            TO OR USE OF OUR SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION
            STORED THEREIN; (D) ANY UNAUTHORIZED ACCESS TO OUR USE OF LINKED
            PAYMENT PROVIDERS SERVERS</span
          ><span class="c1"
            >AND/OR ANY AND ALL PERSONAL AND/OR FINANCIAL INFORMATION STORED
            THEREIN; (E) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR
            FROM THE DISCLAIMED ITEMS; (F) ANY CORRUPTION OR LOSS OF DATA
            TRANSMITTED TO OR FROM THE DISCLAIMED ITEMS; (G) ANY BUGS, VIRUSES,
            TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH
            THE DISCLAIMED ITEMS BY ANY THIRD-PARTY.
          </span>
        </p>
        <p class="c3">
          ...
          THROUGH THE DISCLAIMED ITEMS AND THIRD-PARTIES, AND THE SRC PARTIES
        ...
        <p class="c3">
          ...
          IMPLIED WARRANTIES OR THE LIMITATIONS ON SRCLICABLE STATUTORY RIGHTS
        ...
        <p id="h.3znysh7" class="c3">
          <span
            >You agree to indemnify, defend and hold SRC and the SRC
          ...
          your use or misuse of SRC and or the Services, your breach of these
        ...
        <p class="c3">
          ...
          WITH THE DEBTOR.&rdquo;
        </p>
        <p class="c3">
          If the Services are at any time deemed an electronic commercial
          service (as defined under California Civil Code Section 1789.3),
          California residents are entitled to the following specific consumer
          rights information:
        </p>
        <p class="c3">
          <span
            >The provider of the Services is: SRC International Software
        ...
        <p class="c3">
          <span>UNDER NO CIRCUMSTANCES SHALL ANY SRC PARTY</span>OR ANY OF
        ...
        <p class="c3">
          (A) YOUR USE OF, OR INABILITY TO USE, SRC OR SERVICES;
        </p>
        <p class="c3">
          (B) ANY CONTENT, MATERIALS OR INFORMATION AVAILABLE THROUGH SRC OR
          SERVICES;
        </p>
        <p class="c3">
          (C) ANY PERSONAL INJURY, PROPERTY DAMAGE, LOST PROFITS, COST OF
          SUBSTITUTE GOODS OR SERVICES, LOSS OF DATA, LOSS OF GOODWILL, BUSINESS
          INTERRUPTION, COMPUTER FAILURE OR MALFUNCTION, OR CONSEQUENTIAL,
        ...
        <p class="c3">
          ...
          OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF (A) THE
          MAXIMUM AMOUNT YOU PAID FOR THE SERVICES AND (B) FIFTY DOLLARS
          ($50.00).
        </p>
        <p class="c3">
          BECAUSE SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF
          CERTAIN CATEGORIES OF DAMAGES, THE ABOVE LIMITATION MAY NOT APPLY TO
          YOU. IN SUCH JURISDICTIONS, THE SRC PARTIES&rsquo; AGGREGATE
        ...
        <p class="c3">
          ...
          REGARDLESS OF WHETHER SUCH DAMAGES WERE FORESEEABLE OR WE WERE ADVISED
        ...
        <p class="c3">
          You agree that your electronic signature to these Terms (including
          checking a box to confirm that you have read, understood and agree to
          these Terms) is intended to authenticate this writing and to have the
          same force and effect as your manual signature. For purpose of these
          Terms, your electronic signature is any electronic sound, symbol or
          process attached to or logically associated with these Terms and
        ...
        <p class="c3">
          The Services are based in the State of Delaware and our servers are hosted by Amazon Web Services in the United States. The Servicesare provided for access and use only by persons located in certain states, countries, and territories (collectively, “Permitted Regions”). You acknowledge that you may not be able to access SRC or all or some of the Services or particular features of the Services outside of Permitted Regions and that access thereto may not be legal by certain persons or in certain countries. If you access SRC or the Services from outside a Permitted Region, you are responsible for compliance with local laws.
        </p>
        <li class="c2">
          Dispute resolution
        </li>
        <p class="c3">
          ...
          CLAIMS) WITH SRC LIMITS THE AMOUNT OF TIME YOU HAVE TO BRING CLAIMS
          AGAINST SRC AND LIMITS THE MANNER IN WHICH YOU CAN SEEK RELIEF FROM
          SRC (NO CLASS ARBITRATIONS, CLASS ACTIONS OR REPRESENTATIVE ACTIONS
          OR ARBITRATIONS).
        </p>
        <p class="c3">
        ...
        <p class="c3">
          You and SRC agree to waive any right to a jury trial, or the right
          ...
          provided, however, that you have the right to litigate any Dispute in
          small claims court, if all the requirements of the small claims court,
          including any limitations on jurisdiction and the amount at issue in
          the Dispute, are satisfied. You agree to bring a Dispute in small
          claims court in Delaware.
        </p>
        <p class="c3">
          This Section is referred to in these Terms as the &ldquo;Arbitration
          ...
          these Terms, or access to and use of SRC or the Services, including
          ...
          and SRC empower the arbitrator with the exclusive authority to
          ...
          these terms are void or voidable. The Federal Arbitration Act governs
        ...
        <p class="c3">
          YOU AND SRC BOTH AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER
          ...
          BOTH YOU AND SRC AGREE OTHERWISE, THE ARBITRATOR MAY NOT CONSOLIDATE
          ...
          ANY RELIEF AWARDED CANNOT AFFECT OTHER USERS OF THE SRC SERVICE OR
          SRC.
        </p>
        <p class="c3">
        ...
        <p class="c3">
          <span
            ...
            You and SRC agree that you shall attempt to resolve any dispute
            ...
            of Dispute must: (a) include the full name and contact information
            of the complaining party; (b) describe the nature and basis of the
            ...
            Dispute hello@harmony.one.</span
          >
        </p>
        <p class="c3">
        ...
        <p class="c3">
          ...
          claim or cause of action arising out of or related to use of SRC,
        ...
        <p class="c3">
          <span
            ...
            with the rules of the Judicial Arbitration and Mediation Services
            (&ldquo;JAMS&rdquo;) in effect on the date the arbitration is filed
            (&ldquo;JAMS Rules&rdquo;). JAMS is independent from us, and you may
            obtain copies of the current JAMS Rules, and other related
            materials, including forms and instructions for initiating
            arbitration, by contacting JAMS at 1920 Main Street, Suite 300,
            Irvine, CA 92614 1-800-352-5267 or jamsadr.com.</span
          >
        </p>
        <p>
          ...
          control unless the arbitrator determines that application of the
          ...
          limitation, the limitation of liability provisions. Although
          arbitration proceedings are usually simpler and more streamlined than
          trials and other judicial proceedings, the arbitrator can award the
          same damages and relief on an individual basis that a court can award
          to an individual under these Terms and applicable law. Decisions by
          the arbitrator are enforceable in court and may be overturned by a
          court only for very limited reasons.
        </p>
        <p class="c3">
          For all such arbitration proceedings, you and SRC each irrevocably
          submit to the exclusive jurisdiction of JAMS arbitration in Delaware and waive any jurisdictional, venue, or inconvenient forum
          objections to such arbitration. If the value of the relief sought is
          $7,500 or less you or SRC may elect to have the arbitration
          conducted by telephone or based solely on written submissions, which
          election shall be binding on you and SRC subject to the
          ...
          by telephone by you and/or SRC, unless the arbitrator requires
          otherwise.
        </p>
        <p class="c3">
          The arbitrator will decide the substance of all claims in accordance
          with the laws of the State of Delaware, including recognized
          ...
          prior arbitrations involving different users of the Services or SRC
          but is bound by rulings in prior arbitrations involving you and your
          use of the Services and/or SRC to the extent required by applicable
          law.
        </p>
        <p class="c3">
        ...
        <p class="c3">
          ...
          the JAMS Rules, unless otherwise provided in this Agreement to
          Arbitrate. Each party will be responsible for all fees it incurs in
          connection with the arbitration, including without limitation, all
          attorneys&#39; fees. In the event the arbitrator determines the
          claim(s) you assert in the arbitration to be frivolous, you agree to
          reimburse us all fees associated with the arbitration paid by us on
        ...
        <p class="c3">
          ...
          and Representative Actions and Non-Individualized Relief&rdquo;, is
          ...
          be enforceable as so modified. If a court decides that any of the
          provisions of the section entitled &ldquo;Prohibition of Class and
          Representative Actions and Non-Individualized Relief&rdquo;, is
        ...
        <p class="c3">
          <span
            ...
            and SRC agree that if we make any change</span
          ...
          against us prior to the effective date of the change. Moreover, if we
          seek to terminate this Arbitration Agreement from these Terms, such
          termination shall not be effective until thirty (30) days after the
          version of these Terms not containing the Arbitration Agreement is
          posted to the terms of service page on our website, and shall not be
        ...
        <p class="c3">
          ...
          Policy, located at https://SRC.io/privacy. The Privacy Policy is
          incorporated into these Terms, and by using SRC and/or the Services,
        ...
        <p class="c3">
          Your data is collected, used, stored and transmitted by SRC on
        ...
        <p class="c3">
          ...
          may collect information about you when you use SRC and/or the
          ...
          providing any information to third-parties. We are not responsible for
        ...
        <p class="c3">
          UGC includes any content you make available to other users of SRC or
          ...
          interaction with customer service or any of our employees).
        </p>
        <p class="c3">
          You are responsible for your UGC. You may not upload UGC that
          infringes a third-party&#39;s intellectual property rights, privacy
          rights, publicity rights or other rights of any person or entity or
          that violates the law or this Agreement. In addition, to the extent
          allowed by applicable laws you agree that you do not have any
          &ldquo;moral rights&rdquo; to such material. When you contribute UGC
          the information you contribute is public information and will be seen
          by the public.
        </p>
        <p class="c3">
          You acknowledge and agree that we have the right (but not the
          obligation) to monitor UGC and to alter, remove or refuse to post or
          allow posting of any UGC; however, we do not endorse or guarantee the
          ...
          obligation or liability for UGC made available on SRC and we have no
        ...
        <p class="c3">
          WE TAKE NO RESPONSIBILITY AND ASSUME NO LIABILITY FOR ANY UGC,
          INCLUDING LOSS OR DAMAGE RESULTING FROM YOUR RELIANCE ON INFORMATION
          OR OTHER CONTENT IN SUBMISSIONS.
        </p>
        <p class="c3">
          When you contribute UGC, you grant us and our licensors a worldwide,
          non-exclusive, perpetual, transferable, sublicensable license to use,
          host, store, reproduce, distribute, transcode, translate, broadcast
          modify, create derivative works, publicly perform, publicly display or
          otherwise transmit and communicate the UGC, or any portion thereof, in
          any manner or form and in any medium or forum, whether now known or
          hereafter devised, without notice, payment or attribution of any kind
          to you or any third-party. We are the sole owner of any derivative
          works created by us from your UGC and are therefore entitled to grant
          license on any such derivative works.
        </p>
        <p class="c3">
          We encourage you not to publicly disclose any Personal Information (as
          defined in our Privacy Policy) in any UGC that is or may become
          publicly available because other people may see and use the Personal
          Information in such UGC.
        </p>
        <p class="c3">
          <span
            >You also grant all other users who can access and use your UGC on
            the Services or SRC the right to use,copy, modify, display,
            perform, create derivative works from,</span
          ><a id="id.2et92p0"></a
          ><span class="c1"
            >and otherwise communicate and distribute your UGC on or through the
        ...
        <p class="c3">
          ...
          materials or other information about us, SRC and/or the Services
          ...
          us. You agree that we and our affiliates shall be able to use the
        ...
        <p class="c3">
          <span
            ...
            any UGC or other content on SRC or Services infringes upon your
        ...
        <ul class="lst-kix_list_6-0 start">
          ...
          <li class="c3 c6">
            ...
            of where such work or work(s) can be found on SRC;
          </li>
          <li class="c3 c6">
          ...
          <li class="c3 c6">
            A statement that the information in the notification<span class="c1"
        ...
        <p class="c3">
          <span
            ...
            DMCA Notices&rdquo; to hello@harmony.one</span
          >
          ...
          customer service at hello@harmony.one. You acknowledge that if you fail
        ...
        <ul class="lst-kix_list_6-0">
          ...
          <li class="c3 c6">
            A statement that you have a good faith belief that the UGC was
          ...
          <li class="c3 c6">
            ...
            that you consent to the jurisdiction of the courts in the State of Delaware, and a statement that you will accept service of
            process from the person who provided notification of the alleged
            infringement.
          </li>
        </ul>
        <p class="c3">
          If a counter-notice is received by the DMCA Agent, we may send a copy
          of the counter-notice to the original complaining party informing that
          person that it may replace the removed UGC or cease disabling it in
          ten (10) business days. Unless the copyright owner files an action
          seeking a court order against the UGC provider, member or user, the
          removed UGC may be replaced, or access to it restored, in ten (10) to
        ...
        <p id="h.tyjcwt" class="c3">
          ...
          terminate your access and use of SRC and/or Services and/or your
          ...
          barred from accessing or using SRC and any Service again. Upon
        ...
        <p class="c3">
          ...
          access to SRC or Services.
        </p>
        <p class="c3">
          You can stop using SRC or the Services at any time. You may
        ...
        <p class="c3">
          ...
          delete all copies of SRC from your Device. Termination will not
        ...
        <ul class="lst-kix_list_17-0 start">
          <li class="c3 c6">
            These Terms control the relationship between SRC and you. They do
            not create any third-party beneficiary rights;
          </li>
          <li class="c3 c6">
            These Terms (i) inure to the benefit of and will be binding upon us
            and you and your successors and assigns, respectively and (ii) may
            be assigned by us, but you may not assign them without our prior
            express written consent;
          </li>
          <li class="c3 c6">
            These Terms, together with our Privacy Policy, contain the entire
            understanding by and between SRC and you with respect to the
            matters contained herein;
          </li>
          <li class="c3 c6">
            If any provision of these Terms is or becomes unenforceable or
            invalid, the remaining provisions will continue with the same effect
            as if such unenforceable or invalid provision had not been inserted
            herein;
          </li>
          <li class="c3 c6">
            If we fail or you fail to perform any of these Terms and you do not
            enforce the term, the failure to enforce on any occasion will not
            constitute a waiver of any term and will not prevent enforcement on
            any other occasion;
          </li>
          <li class="c3 c6">
            Nothing contained in these Terms will be deemed to constitute SRC
            or you as the agent or representative of the other or as joint
            venturers or partners;
          </li>
          <li class="c3 c6">
            If we or you are prevented from performing or unable to perform any
            obligation under these Terms due to any cause beyond the reasonable
            control of the party invoking this provision, the affected
            party&rsquo;s performance will be extended for the period of delay
          ...
          <li class="c3 c6">
            These Terms and all related documentation are drafted in English.
            While certain text in these Terms may be made available in languages
            other than English (whether translated by a person or solely by
            computer software), the English language version controls.
          </li>
          <li class="c3 c6">
            These Terms, and any dispute between you and SRC, shall be
            ...
            the Arbitration Agreement. Unless you and we agree otherwise, in the
            event that the Arbitration Agreement is found not to apply to you or
            to a particular claim or dispute (except for small-claims court
            actions), as a result of a decision by the arbitrator or a court
            order, you agree that any claim or dispute that has arisen or may
            arise between you and SRC must be resolved exclusively by a state
            or federal court located in the State of Delaware. You and
            SRC agree to submit to the personal jurisdiction of the courts
            located within the State of Delaware for the purpose of
            litigating all such claims or disputes.
          </li>
          <li class="c3 c6">
            You affirm that you are more than 18 years of age (or applicable age
            of majority in your territory, state or country) or, if signing
            on behalf of a company, have legal capacity to enter into this
            Agreement.
          </li>
          <li class="c3 c6">
            You agree to follow all Canadian and other export control laws and
            agree not to transfer any of our Services to a foreign national, or
            national destination, that is prohibited by such laws.
          </li>
          <li class="c3 c6">
            You acknowledge that you are not a person with whom we are prohibited
