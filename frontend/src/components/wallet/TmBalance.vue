  ...
  <div class="balance-header">
    <div class="values-container">
      <div class="total-atoms">
        ...
        <h2 class="total-atoms__value">{{ totalAtomsDisplay | ones | fourDecimals }}</h2>
      </div>
    ...
    <div class="button-container">
      ...
      />
      <TmBtn class="send-button" value="Transfer funds" type="secondary" @click.native="onSend()" />
    </div>

    <SendModal ref="SendModal" />
    <ModalWithdrawRewards ref="ModalWithdrawRewards" :rewards="rewards" :denom="bondDenom" />
  </div>
</template>
<script>
